...
public:
	...
	LPDISPATCH get_DefaultPivotTableLayoutOptions()
	{
		LPDISPATCH result;
		InvokeHelper(0xcc7, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_TruncateLeadingZeros()
	{
		BOOL result;
		InvokeHelper(0xcf0, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_TruncateLeadingZeros(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcf0, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_TruncateLargeNumbers()
	{
		BOOL result;
		InvokeHelper(0xcf1, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_TruncateLargeNumbers(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcf1, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_ConvertNumbersWithECharacter()
	{
		BOOL result;
		InvokeHelper(0xcf2, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ConvertNumbersWithECharacter(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcf2, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVDisplayNumberConversionWarning()
	{
		BOOL result;
		InvokeHelper(0xcf3, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVDisplayNumberConversionWarning(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcf3, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	BOOL get_CSVKeepColumnAsTextIfMultipleEntriesAreText()
	{
		BOOL result;
		InvokeHelper(0xcf4, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_CSVKeepColumnAsTextIfMultipleEntriesAreText(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcf4, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_DataPrivacyOptions()
	{
		LPDISPATCH result;
		InvokeHelper(0xcf5, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	BOOL get_ShowConvertToDataType()
	{
		BOOL result;
		InvokeHelper(0xcef, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, nullptr);
		return result;
	}
	void put_ShowConvertToDataType(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL;
		InvokeHelper(0xcef, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, newValue);
	}
	LPDISPATCH get_SensitivityLabelPolicy()
	{
		LPDISPATCH result;
		InvokeHelper(0xd25, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
