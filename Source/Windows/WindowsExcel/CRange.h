...
public:
	...
	VARIANT _AutoFilter(VARIANT& Field, VARIANT& Criteria1, long Operator, VARIANT& Criteria2, VARIANT& VisibleDropDown)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT;
	...
	{
		LPUNKNOWN result;
		InvokeHelper(0xfffffffc, DISPATCH_PROPERTYGET, , (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_Next()
	{
	...
	BOOL _Replace(VARIANT& What, VARIANT& Replacement, VARIANT& LookAt, VARIANT& SearchOrder, VARIANT& MatchCase, VARIANT& MatchByte, VARIANT& SearchFormat, VARIANT& ReplaceFormat)
	{
		BOOL result;
	...
	VARIANT _Sort(VARIANT& Key1, long Order1, VARIANT& Key2, VARIANT& Type, long Order2, VARIANT& Key3, long Order3, long Header, VARIANT& OrderCustom, VARIANT& MatchCase, long Orientation, long SortMethod, long DataOption1, long DataOption2, long DataOption3)
	{
		VARIANT result;
	...
	VARIANT get_HasRichDataType()
	{
		VARIANT result;
		InvokeHelper(0xcfe, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void ShowCard()
	{
		InvokeHelper(0xcca, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	LPDISPATCH AddCommentThreaded(LPCTSTR Text)
	{
		LPDISPATCH result;
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0xcd0, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, Text);
		return result;
	}
	LPDISPATCH get_CommentThreaded()
	{
		LPDISPATCH result;
		InvokeHelper(0xcd1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	VARIANT Sort(VARIANT& Key1, long Order1, VARIANT& Key2, VARIANT& Type, long Order2, VARIANT& Key3, long Order3, long Header, VARIANT& OrderCustom, VARIANT& MatchCase, long Orientation, long SortMethod, long DataOption1, long DataOption2, long DataOption3, VARIANT& SubField1)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_I4 VTS_I4 VTS_VARIANT VTS_VARIANT VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 VTS_VARIANT;
		InvokeHelper(0xcd8, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Key1, Order1, &Key2, &Type, Order2, &Key3, Order3, Header, &OrderCustom, &MatchCase, Orientation, SortMethod, DataOption1, DataOption2, DataOption3, &SubField1);
		return result;
	}
	VARIANT AutoFilter(VARIANT& Field, VARIANT& Criteria1, long Operator, VARIANT& Criteria2, VARIANT& VisibleDropDown, VARIANT& SubField)
	{
		VARIANT result;
		static BYTE parms[] = VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT VTS_VARIANT;
		InvokeHelper(0xcd9, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, &Field, &Criteria1, Operator, &Criteria2, &VisibleDropDown, &SubField);
		return result;
	}
	void ConvertToLinkedDataType(long ServiceID, LPCTSTR LanguageCulture)
	{
		static BYTE parms[] = VTS_I4 VTS_BSTR;
		InvokeHelper(0xcda, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, ServiceID, LanguageCulture);
	}
	VARIANT get_LinkedDataTypeState()
	{
		VARIANT result;
		InvokeHelper(0xcdb, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void SetCellDataTypeFromCell(LPDISPATCH SourceCell)
	{
		static BYTE parms[] = VTS_DISPATCH;
		InvokeHelper(0xcdd, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, SourceCell);
	}
	void DataTypeToText()
	{
		InvokeHelper(0xcde, DISPATCH_METHOD, VT_EMPTY, nullptr, nullptr);
	}
	VARIANT get_HasSpill()
	{
		VARIANT result;
		InvokeHelper(0xcdf, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_SpillingToRange()
	{
		LPDISPATCH result;
		InvokeHelper(0xce0, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	LPDISPATCH get_SpillParent()
	{
		LPDISPATCH result;
		InvokeHelper(0xce1, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, nullptr);
		return result;
	}
	void RefreshLinkedDataType(VARIANT& DomainID)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xce3, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, &DomainID);
	}
	VARIANT get_Formula2()
	{
		VARIANT result;
		InvokeHelper(0x62c, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void put_Formula2(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0x62c, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
	}
	VARIANT get_Formula2Local()
	{
		VARIANT result;
		InvokeHelper(0xce4, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void put_Formula2Local(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xce4, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
	}
	VARIANT get_Formula2R1C1()
	{
		VARIANT result;
		InvokeHelper(0xce5, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void put_Formula2R1C1(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xce5, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
	}
	VARIANT get_Formula2R1C1Local()
	{
		VARIANT result;
		InvokeHelper(0xce6, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	void put_Formula2R1C1Local(VARIANT& newValue)
	{
		static BYTE parms[] = VTS_VARIANT;
		InvokeHelper(0xce6, DISPATCH_PROPERTYPUT, VT_EMPTY, nullptr, parms, &newValue);
	}
	VARIANT get_SavedAsArray()
	{
		VARIANT result;
		InvokeHelper(0xce7, DISPATCH_PROPERTYGET, VT_VARIANT, (void*)&result, nullptr);
		return result;
	}
	BOOL Replace(VARIANT& What, VARIANT& Replacement, VARIANT& LookAt, VARIANT& SearchOrder, VARIANT& MatchCase, VARIANT& MatchByte, VARIANT& SearchFormat, VARIANT& ReplaceFormat, VARIANT& FormulaVersion)
	{
		BOOL result;
		...
		InvokeHelper(0xce9, DISPATCH_METHOD, VT_BOOL, (void*)&result, parms, &What, &Replacement, &LookAt, &SearchOrder, &MatchCase, &MatchByte, &SearchFormat, &ReplaceFormat, &FormulaVersion);
		return result;
	}
